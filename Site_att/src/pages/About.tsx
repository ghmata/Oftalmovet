        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-foreground/80">
              Conheça o Dr. Leonardo F. Balthazar e sua dedicação à oftalmologia veterinária
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            >
              ...
              <div className="bg-primary/10 border border-primary/30 p-6 rounded-xl shadow-elevated w-fit mx-auto lg:mx-0">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                className="bg-card p-5 sm:p-6 lg:p-8 rounded-2xl shadow-card text-center"
              >
